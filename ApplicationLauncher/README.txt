...
-Setting the custom savepath in the settings will currently not delete existing savefiles from the previous directory nor will it change the .config file that contains the path
from where savefiles are loaded !
